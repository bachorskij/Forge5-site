  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        forge: "bg-primary text-primary-foreground font-heading font-bold tracking-tight shadow-[0_0_20px_-4px_oklch(0.75_0.18_75/40%)] hover:shadow-[0_0_30px_-4px_oklch(0.75_0.18_75/60%)] hover:bg-primary/90 transition-all",
        forgeOutline: "border-2 border-primary text-primary font-heading font-bold tracking-tight hover:bg-primary hover:text-primary-foreground transition-all"
      },
      size: {
...
const logo = "/assets/forge5-logo-BLG4qEEg.png";
const navLinks = [
  { to: "/", label: "Home" },
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-20 max-w-6xl items-center justify-between px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center gap-2 -my-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Forge5 Designs", className: "h-16 w-auto sm:h-20" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-1 md:flex", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "forge", size: "sm", className: "ml-3", children: "Get a Quote" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: mobileOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M6 18L18 6M6 6l12 12" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M4 6h16M4 12h16M4 18h16" }) })
        }
      )
    ] }),
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "border-t border-border/50 bg-background/95 backdrop-blur-xl md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-6xl flex-col gap-1 px-4 py-4", children: [
      navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: link.to,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", onClick: () => setMobileOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "forge", size: "sm", className: "mt-2 w-full", children: "Get a Quote" }) })
    ] }) })
  ] });
}
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border/50 bg-surface", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-4 py-12 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 sm:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-1 sm:col-span-2 lg:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Forge5 Designs", className: "h-12 w-auto", loading: "lazy" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Brand identity & digital design for the trades. London, Ontario." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold text-foreground", children: "Navigation" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 space-y-2", children: [
          { to: "/services", label: "Services" },
          { to: "/portfolio", label: "Portfolio" },
          { to: "/about", label: "About" },
          { to: "/contact", label: "Contact" }
        ].map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: link.to, className: "text-sm text-muted-foreground transition-colors hover:text-primary", children: link.label }) }, link.to)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold text-foreground", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 space-y-2", children: ["Brand Identity", "Vehicle Wraps", "Digital Presence", "Print Design"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: s }) }, s)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold text-foreground", children: "Get in Touch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-3 space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "London, Ontario" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:hello@forge5designs.com", className: "transition-colors hover:text-primary", children: "hello@forge5designs.com" }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 border-t border-border/50 pt-6 text-center text-xs text-muted-foreground", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Forge5 Designs. All rights reserved."
    ] })
  ] }) });
}
const appCss = "/assets/styles-B5A6ZzH-.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading text-7xl font-extrabold text-primary", children: "404" }),
...
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professional brand identity and digital design for contractors, tradespeople, and industrial small businesses in London, Ontario." },
      { name: "author", content: "Forge5 Designs" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter+Tight:wght@400;600;700;800;900&family=DM+Sans:wght@400;500;600;700&display=swap" }
    ]
  }),
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}, location.pathname) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {})
  ] });
}
const $$splitComponentImporter$4 = () => import("./services-sHijOZq4.js");
const Route$4 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Brand identity, vehicle wraps, signage, and digital design forged for contractors and tradespeople."
    }, {
      property: "og:title",
      content: "Services — Forge5 Designs"
    }, {
...
const $$splitComponentImporter$3 = () => import("./portfolio-DY1OKOuR.js");
const Route$3 = createFileRoute("/portfolio")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Brand identity work forged for contractors, tradespeople, and bold businesses. See what we build."
    }, {
      property: "og:title",
      content: "Portfolio — Forge5 Designs"
    }, {
      property: "og:description",
      content: "Brand identity work forged for contractors, tradespeople, and bold businesses. See what we build."
    }]
...
const $$splitComponentImporter$2 = () => import("./contact-ChRzEi96.js");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get a free brand audit or start your project. Forge5 Designs — brand identity forged for the trades."
    }, {
      property: "og:title",
      content: "Contact — Forge5 Designs"
    }, {
      property: "og:description",
      content: "Get a free brand audit or start your project. No pitch, no pressure."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-CdFAnkw3.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A one-person design studio in London, Ontario. Brand identity forged for tradespeople and blue-collar businesses."
    }, {
      property: "og:title",
      content: "About — Forge5 Designs"
    }, {
      property: "og:description",
      content: "A one-person design studio in London, Ontario. Brand identity forged for tradespeople and blue-collar businesses."
    }]
...
const $$splitComponentImporter = () => import("./index-CKTzj4if.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Brand identity and digital design forged for contractors, tradespeople, and blue-collar businesses in London, Ontario."
    }, {
      property: "og:title",
      content: "Forge5 Designs — Brand Identity for the Trades"
    }, {
      property: "og:description",
      content: "Brand identity and digital design forged for contractors, tradespeople, and blue-collar businesses in London, Ontario."
    }]
